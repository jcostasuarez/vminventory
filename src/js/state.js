 ...
 * @property {boolean} forzar_qemu - Fuerza el uso de qemu-img para todos los discos.
 * @property {string} ruta_qemu_img - Ruta personalizada al binario ejecutable qemu-img.
...
export class AppState {
  ...
  obtenerPayload() {
    return {
      ...
      ruta_qemu_img: this.config.ruta_qemu_img ? this.config.ruta_qemu_img : null,
